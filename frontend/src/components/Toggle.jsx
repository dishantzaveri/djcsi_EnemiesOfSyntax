  ...
  return (
    <Switch.Group as="div" {...props}>
      <div className="flex items-center">
        <span className={`text-sm mr-3 font-medium ${!sideBySide ? 'text-white' : 'text-gray-500'}`}>Side by Side</span>
        <Switch
          checked={sideBySide}
        ...
        <Switch.Label as="span" className="ml-3">
          <span className={`text-sm font-medium ${sideBySide ? 'text-white' : 'text-gray-500'} `}>Compare</span>
        </Switch.Label>
      </div>
    </Switch.Group>
  );
