const testimonials = [
  [
    ...
    {
      content: 'Finally! Something to help me get over my indecisiveness when decorating my house!',
  ...
  [
    ...
    {
      content: "I haven't changed my room layout for 5 years, but this app may change that. Great job.",
...
export default function Testimonials() {
  return (
    <section id='testimonials' aria-label='What our customers are saying' className='py-10'>
                    ...
                    <a href={testimonial.link} target='_blank' rel='noreferrer'>
                      <figure className='relative rounded-2xl bg-gray-600 p-6 shadow-xl shadow-slate-900/10'>
                        <blockquote className='relative'>
                          <p className='text-lg tracking-tight text-white'>"{testimonial.content}"</p>
                        </blockquote>
                        <figcaption className='relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6'>
                          <div>
                            <div className='font-display text-base text-white'>{testimonial.author.name}</div>
                            <div className='mt-1 text-sm text-gray-400'>{testimonial.author.role}</div>
                          </div>
