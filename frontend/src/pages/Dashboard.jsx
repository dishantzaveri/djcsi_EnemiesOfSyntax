...
const Dashboard = () => {
    ...
    const handleFile = (e) => {
        ...
        if (validImageTypes.includes(fileType)) {
            setFile(file1);
            localStorage.setItem('file', file1);
        } else {
        ...
        <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 background-gradient">
            ...
            <div className="flex w-full gap-8 my-12">
                <div className="px-20 rounded-xl border-2 border-purple-600 bg-purple-100/10 shadow-xl hover:scale-105 hover:shadow-purple-500/50 transform duration-300 shadow-purple-500/25 py-12 flex flex-col items-center gap-8 w-full">
                    ...
                    <h1 className="mx-auto max-w-xl text-lg sm:text-gray-400  text-gray-500 leading-7">Choose wall and color it with our recommended palette</h1>
                    <button onClick={() => {
                        if(file) {
                            navigate('/paint')
                        } else {
                ...
                <div className="px-20 rounded-xl border-2 border-purple-600 bg-purple-100/10 shadow-xl hover:scale-105 hover:shadow-purple-500/50 transform duration-300 shadow-purple-500/25 py-12 flex flex-col items-center gap-8 w-full">
                    ...
                    <h1 className="mx-auto max-w-xl text-lg sm:text-gray-400  text-gray-500 leading-7">Use our ControlNet model to generate room based on your theme.</h1>
                    <button onClick={() => {
                        if(file) {
                            navigate('/generate')
                        } else {
